...
void DDTableBuffer::open() {
  ...
  table = dict_mem_table_create(table_name, dict_sys_t_s_space_id, N_USER_COLS,
                                0, 0, 0);

  table->id = dict_sys_t::s_dynamic_meta_table_id;
  table->is_dd_table = true;
  table->dd_space_id = dict_sys_t_s_dd_space_id;
  ...
  m_index = dict_mem_index_create(table_name, "PRIMARY", dict_sys_t_s_space_id,
